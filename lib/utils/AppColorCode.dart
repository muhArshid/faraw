...
class AppColorCode {
  ...
  static const Color gray1 = Color.fromRGBO(134, 147, 163, 1);
  static const Color grey2 = Color(0xFF8D969F);
  static const Color pureWhite = Color(0xFFFFFFFF);
  static const Color border = Color(0xFFEDF0F2);
  static const Color backgroundColor = Color(0xFFE5E5E5);
  static const Color brandColor = Color(0xFF2A4A88);
  //text
  static const Color text1 = Color.fromRGBO(34, 33, 91, 1);
  static const Color headerColor = Color(0xFF1A237E);
  static const Color labelColor = Color(0xFF3E6080);
  static const Color SubHeaderColor = Color(0xFF07456F);
  //butten
